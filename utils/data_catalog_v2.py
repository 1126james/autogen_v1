...
# STILL TESTING
# testing if json (current) / md / natural langauge are better for LLM comprehension
...
if __name__ == "__main__":
    df = LoadDataset(Path("C:/Users/James/Desktop/python/autogen_v1/sheets/sample2.csv"))
